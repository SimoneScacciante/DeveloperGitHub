...
function render(){
    ...
    for (let i = 0; i < posts.length; i++) {
        ...
        content.innerHTML += `<div class="contentHeader">
    ...
    <div class="comments fontSize14">
        ...
        <div class="commentContainer${i}"><span class="bold">${newPosts['user']}</span><span class="comment">${newPosts['discription']}</span><br></div>
                    </div>
                    <div class="inputContainer">
                        <input type="text" placeholder="Kommentieren..." id="commentInput${i}">
                        <div class="changeUser" onclick="addcomment(${i})"><span>Posten</span></div>
        ...
        for (let j = 0; j < newPosts['comments'].length; j++) {
            ...
            commentsContainer.innerHTML += `<span class="bold">${commentsIndex['user']}</span><span class="comment">${commentsIndex['comment']}</span><br>`;
        }
    }
}
//=================== Comments==============
