...
function render() {
    ...
    for (let i = 0; i < postArray.length; i++) {
        ...
        <div class="contentCommentsContainer">
            ...
            <div>                           <!-- gebe <span> und NICHT <p> Tag ein sonst checkt es das nicht -->
...
function addlike(i) {
    ...
    if (document.getElementById(`heartID${i}`).getAttribute('src') === './icon/heartBtns1.ico') {
        ...
        /* Fügt +1 Hinzu            du musst hier ID von likesID eingeben da er sonst ${i} Werte verwirrt zuweist  
                                    du kannst eben NICHT nur "postArray[i]['likes'] += 1 UND render();"  schreiben da es sonst konflikte
                                    mit oberen Teil gibt bezüglich Herz Bild Austausch*/    
        ...
        /* zieht -1 ab */
        document.getElementById(`likesID${i}`).innerHTML = postArray[i]['likes'] -= 1;
       /* render()  einzugeben ist NICHT nötig! */
...
Alternativ: Ersetzte kokmplett addlike(i) mit.... 
